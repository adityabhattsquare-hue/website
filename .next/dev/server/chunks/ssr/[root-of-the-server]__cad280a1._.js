...
"[project]/services/data:f2703f [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/services/data:d545c9 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/services/data:daf012 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$data$3a$f2703f__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/services/data:f2703f [app-ssr] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$data$3a$d545c9__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/services/data:d545c9 [app-ssr] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$data$3a$daf012__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/services/data:daf012 [app-ssr] (ecmascript) <text/javascript>");
;
;
...
const loginUser = (email, password)=>async (dispatch)=>{
        try {
            ...
            dispatch(clearError());
            const userData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$data$3a$f2703f__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["login"])(email, password);
...
const registerUser = (name, email, password, phone = '')=>async (dispatch)=>{
        try {
            dispatch(setLoading(true));
            dispatch(clearError());
            const userData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$data$3a$d545c9__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["register"])(name, email, password, phone);
            // Store token and user data only on client side
            if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
            ;
            dispatch(setUser(userData));
...
const logoutUserAsync = ()=>async (dispatch)=>{
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$data$3a$daf012__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["logout"])();
        } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cad280a1._.js.map